      ...
      <div className="relative z-10">
        ...
        <div className="w-full">
          <section id="about" className="mx-auto flex w-full scroll-mt-8 flex-col items-center px-6 pb-24 pt-16 text-center md:pb-32 md:pt-24">
            <div className="flex w-full max-w-4xl flex-col items-center rounded-2xl border border-border/80 bg-white/90 px-6 py-10 shadow-sm backdrop-blur-md md:px-12 md:py-14">
